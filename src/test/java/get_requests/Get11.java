...
public class Get11 extends GoRestBaseUrl {
    ...
    public void get11() {
        ...
        //send the requesr and the get response
        ...
        response
                ...
                .body("data.status", hasItem("active"))// bos olursa datadaki tum statusleri arar
        ...
        System.out.println("female = " + femaleList.size());
        List<Object> maleList = json.getList("data.findAll{it.gender=='male'}");
        System.out.println("male = " + maleList.size());
